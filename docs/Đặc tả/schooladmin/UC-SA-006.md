...
- **Kết quả sau cùng:**
  - Bài đăng/thông báo được gửi đến phụ huynh và giáo viên.
- **Luồng chính:**
  1. School Admin truy cập chức năng quản lý bài đăng/thông báo.
  2. Tạo mới hoặc chỉnh sửa nội dung.
  3. Gửi thông báo đến các đối tượng liên quan.
- **Luồng thay thế:**
  - Nội dung thông báo thiếu thông tin:
    1. Hệ thống báo lỗi.
...
- **Postconditions:**
  - Post/announcement is sent to parents and teachers.
- **Normal Flow:**
...
- **Alternative Flows:**
  - Missing announcement content:
    ...
    2. School Admin adds and resends.